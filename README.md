...
### Développement Web – ENSAH  
*HTML, CSS, JavaScript, Laravel, MySQL*

- Application web dynamique pour la gestion des utilisateurs (CRUD complet).  
...
### Système de gestion des étudiants – C / Algorithmique  
*C, GTK3, OpenSSL*

- Application de bureau avec interface graphique GTK3 pour gérer étudiants et notes.  
- Stockage sécurisé des données avec chiffrement AES‑256 via OpenSSL.  
- Structures de données adaptées pour la recherche rapide et la manipulation de listes.  

---

### KarimFitnessProject – Frontend Web  
*HTML, CSS, JavaScript, TypeScript*

- Interface moderne orientée fitness et bien‑être, responsive et mobile‑first.  
- Utilisation de TypeScript pour un code frontend plus robuste et maintenable.  
- Composants réutilisables pour les sections d’exercices, programmes, statistiques.  

---

### Autres projets et idées

- Scripts et outils pour développeurs (automatisation, monitoring, utilitaires).  
- Exploration de la génération de prompts et d’outils autour de l’IA générative.  
- Projets orientés réseaux et cybersécurité (labs, tests de configuration).  
